...
![Data structure of a Linear Allocator](https://github.com/likhitha-k8/memory-allocators/tree/main/docs/images/linear1.png)
...
![Data structure of a Stack Allocator](https://github.com/likhitha-k8/memory-allocators/tree/main/docs/images/stack1.png)
...
![Allocating memory in a Stack Allocator](https://github.com/likhitha-k8/memory-allocators/tree/main/docs/images/stack2.png)
...
![Freeing memory in a Stack Allocator](https://github.com/likhitha-k8/memory-allocators/tree/main/docs/images/stack3.png)
...
![Splitting scheme in a Pool Allocator](https://github.com/likhitha-k8/memory-allocators/tree/main/docs/images/pool1.png)
...
![Linked List used in a Pool Allocator](https://github.com/likhitha-k8/memory-allocators/tree/main/docs/images/pool2.png)
...
![In memory Linked List used in a Pool Allocator](https://github.com/likhitha-k8/memory-allocators/tree/main/docs/images/pool3.png)
...
![Allocation in a Pool Allocator](https://github.com/likhitha-k8/memory-allocators/tree/main/docs/images/pool4.png)

The linked list doesn't have to be sorted. Its order its determined by the how the allocations and free are done.

![Random State of a Linked List in a Pool Allocator](https://github.com/likhitha-k8/memory-allocators/tree/main/docs/images/pool5.png)
...
![Data structure in a Free list Allocator](https://github.com/likhitha-k8/memory-allocators/tree/main/docs/images/freelist_seq1.png)
...
![Allocating in a Free list Allocator](https://github.com/likhitha-k8/memory-allocators/tree/main/docs/images/freelist_seq2.png)
...
![Freeing in a Free list Allocator](https://github.com/likhitha-k8/memory-allocators/tree/main/docs/images/freelist_seq3.png)
...
![Time complexity of different allocators](https://github.com/likhitha-k8/memory-allocators/tree/main/docs/images/operations_over_time.png)
...
![Time complexity of different allocators](https://github.com/likhitha-k8/memory-allocators/tree/main/docs/images/operations_over_time_no_init.png)
...
![Space complexity of different allocators](https://github.com/likhitha-k8/memory-allocators/tree/main/docs/images/operations_over_space.png)
