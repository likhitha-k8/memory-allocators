...
# Table of Contents
&nbsp;[Introduction](https://github.com/likhitha-k8/memory-allocators#introduction)  <br/> 
&nbsp;[Build instructions](https://github.com/likhitha-k8/memory-allocators#build-instructions)  <br/> 
&nbsp;[What's wrong with Malloc?](https://github.com/likhitha-k8/memory-allocators#whats-wrong-with-malloc)  <br/> 
&nbsp;[Custom allocators](https://github.com/likhitha-k8/memory-allocators#custom-allocators)  <br/> 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Linear Allocator](https://github.com/likhitha-k8/memory-allocators#linear-allocator)  <br/> 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Stack Allocator](https://github.com/likhitha-k8/memory-allocators#stack-allocator)  <br/> 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Pool Allocator](https://github.com/likhitha-k8/memory-allocators#pool-allocator)  <br/> 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Free list Allocator](https://github.com/likhitha-k8/memory-allocators#free-list-allocator)  <br/> 
&nbsp;[Benchmarks](https://github.com/likhitha-k8/memory-allocators#benchmarks)  <br/> 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Time complexity](https://github.com/likhitha-k8/memory-allocators#time-complexity)  <br/> 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Space complexity](https://github.com/likhitha-k8/memory-allocators#space-complexity)  <br/> 
&nbsp;[Summary](https://github.com/likhitha-k8/memory-allocators#summary)  <br/> 
&nbsp;[Last thoughts](https://github.com/likhitha-k8/memory-allocators#last-thoughts)  <br/> 
...
```c
git clone https://github.com/likhitha-k8/memory-allocators.git
...
![Data structure of a Linear Allocator](https://github.com/likhitha-k8/memory-allocators/blob/master/docs/images/linear1.png)
...
![Allocating memory in a Linear Allocator](https://github.com/likhitha-k8/memory-allocators/blob/master/docs/images/linear2.png)
...
![Data structure of a Stack Allocator](https://github.com/likhitha-k8/memory-allocators/blob/master/docs/images/stack1.png)
...
![Allocating memory in a Stack Allocator](https://github.com/likhitha-k8/memory-allocators/blob/master/docs/images/stack2.png)
...
![Freeing memory in a Stack Allocator](https://github.com/likhitha-k8/memory-allocators/blob/master/docs/images/stack3.png)
...
![Splitting scheme in a Pool Allocator](https://github.com/likhitha-k8/memory-allocators/blob/master/docs/images/pool1.png)
...
![Linked List used in a Pool Allocator](https://github.com/likhitha-k8/memory-allocators/blob/master/docs/images/pool2.png)
...
![In memory Linked List used in a Pool Allocator](https://github.com/likhitha-k8/memory-allocators/blob/master/docs/images/pool3.png)
...
![Allocation in a Pool Allocator](https://github.com/likhitha-k8/memory-allocators/blob/master/docs/images/pool4.png)

The linked list doesn't have to be sorted. Its order its determined by the how the allocations and free are done.

![Random State of a Linked List in a Pool Allocator](https://github.com/likhitha-k8/memory-allocators/blob/master/docs/images/pool5.png)
...
![Data structure in a Free list Allocator](https://github.com/likhitha-k8/memory-allocators/blob/master/docs/images/freelist_seq1.png)
...
![Allocating in a Free list Allocator](https://github.com/likhitha-k8/memory-allocators/blob/master/docs/images/freelist_seq2.png)
...
![Freeing in a Free list Allocator](https://github.com/likhitha-k8/memory-allocators/blob/master/docs/images/freelist_seq3.png)
...
![Time complexity of different allocators](https://github.com/likhitha-k8/memory-allocators/blob/master/docs/images/operations_over_time.png)
...
![Time complexity of different allocators](https://github.com/likhitha-k8/memory-allocators/blob/master/docs/images/operations_over_time_no_init.png)
...
![Space complexity of different allocators](https://github.com/likhitha-k8/memory-allocators/blob/master/docs/images/operations_over_space.png)
